...
var DjangoAdminLogTableColumns = struct {
	ID            string
	ActionTime    string
	ObjectID      string
	ObjectRepr    string
	...
	ID:            "django_admin_log.id",
	ActionTime:    "django_admin_log.action_time",
	ObjectID:      "django_admin_log.object_id",
	ObjectRepr:    "django_admin_log.object_repr",
	ActionFlag:    "django_admin_log.action_flag",
	ChangeMessage: "django_admin_log.change_message",
	ContentTypeID: "django_admin_log.content_type_id",
	UserID:        "django_admin_log.user_id",
}
...
func (r *djangoAdminLogR) GetContentType() *DjangoContentType {
	if r == nil {
		return nil
	}
...
func (r *djangoAdminLogR) GetUser() *AuthUser {
	if r == nil {
		return nil
	}
	return r.User
...
var (
	...
	djangoAdminLogColumnsWithoutDefault = []string{"action_time", "object_repr", "action_flag", "change_message", "user_id"}
	djangoAdminLogColumnsWithDefault    = []string{"id", "object_id", "content_type_id"}
	djangoAdminLogPrimaryKeyColumns     = []string{"id"}
	djangoAdminLogGeneratedColumns      = []string{}
)
...
func (q djangoAdminLogQuery) One(exec boil.Executor) (*DjangoAdminLog, error) {
	o := &DjangoAdminLog{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: failed to execute a one query for django_admin_log")
	}
...
func (q djangoAdminLogQuery) All(exec boil.Executor) (DjangoAdminLogSlice, error) {
	var o []*DjangoAdminLog

	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schema: failed to assign all query results to DjangoAdminLog slice")
	}
...
func (q djangoAdminLogQuery) Count(exec boil.Executor) (int64, error) {
	var count int64
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to count django_admin_log rows")
	}
...
func (q djangoAdminLogQuery) Exists(exec boil.Executor) (bool, error) {
	var count int64
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schema: failed to check if django_admin_log exists")
	}
...
func (djangoAdminLogL) LoadContentType(e boil.Executor, singular bool, maybeDjangoAdminLog interface{}, mods queries.Applicator) error {
	var slice []*DjangoAdminLog
	var object *DjangoAdminLog

	if singular {
		var ok bool
		object, ok = maybeDjangoAdminLog.(*DjangoAdminLog)
		if !ok {
			object = new(DjangoAdminLog)
			ok = queries.SetFromEmbeddedStruct(&object, &maybeDjangoAdminLog)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", object, maybeDjangoAdminLog))
			}
		}
	} else {
		s, ok := maybeDjangoAdminLog.(*[]*DjangoAdminLog)
		if ok {
			slice = *s
		} else {
			ok = queries.SetFromEmbeddedStruct(&slice, maybeDjangoAdminLog)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", slice, maybeDjangoAdminLog))
			}
		}
	}
	...
	if singular {
		...
		foreign.R.ContentTypeDjangoAdminLogs = append(foreign.R.ContentTypeDjangoAdminLogs, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ContentTypeID, foreign.ID) {
				...
				foreign.R.ContentTypeDjangoAdminLogs = append(foreign.R.ContentTypeDjangoAdminLogs, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (djangoAdminLogL) LoadUser(e boil.Executor, singular bool, maybeDjangoAdminLog interface{}, mods queries.Applicator) error {
	var slice []*DjangoAdminLog
	var object *DjangoAdminLog
	...
	if singular {
		...
		foreign.R.UserDjangoAdminLogs = append(foreign.R.UserDjangoAdminLogs, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserID == foreign.ID {
				...
				foreign.R.UserDjangoAdminLogs = append(foreign.R.UserDjangoAdminLogs, local)
				break
			}
		}
	}
...
func (o *DjangoAdminLog) RemoveContentType(exec boil.Executor, related *DjangoContentType) error {
	...
	if _, err = o.Update(exec, boil.Whitelist("content_type_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
...
func DjangoAdminLogs(mods ...qm.QueryMod) djangoAdminLogQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"django_admin_log\".*"})
	}

	return djangoAdminLogQuery{q}
}
...
func FindDjangoAdminLog(exec boil.Executor, iD int, selectCols ...string) (*DjangoAdminLog, error) {
	...
	err := q.Bind(nil, exec, djangoAdminLogObj)
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			return nil, sql.ErrNoRows
		}
		return nil, errors.Wrap(err, "schema: unable to select from django_admin_log")
	}
...
func (o *DjangoAdminLog) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no django_admin_log provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to insert into django_admin_log")
	}
...
func (o *DjangoAdminLog) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	var err error
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schema: unable to update django_admin_log, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update django_admin_log row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by update for django_admin_log")
	}
...
func (q djangoAdminLogQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	queries.SetUpdate(q.Query, cols)

	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all for django_admin_log")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected for django_admin_log")
	}
...
func (o DjangoAdminLogSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all in djangoAdminLog slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected all in update all djangoAdminLog")
	}
	return rowsAff, nil
}
...
func (o *DjangoAdminLog) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("schema: no django_admin_log provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("schema: unable to upsert django_admin_log, could not build update column list")
		}

		ret := strmangle.SetComplement(djangoAdminLogAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(djangoAdminLogPrimaryKeyColumns) == 0 {
				return errors.New("schema: unable to upsert django_admin_log, could not build conflict column list")
			}

			conflict = make([]string, len(djangoAdminLogPrimaryKeyColumns))
			copy(conflict, djangoAdminLogPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"django_admin_log\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert django_admin_log")
	}
...
func (o *DjangoAdminLog) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("schema: no DjangoAdminLog provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete from django_admin_log")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by delete for django_admin_log")
	}
...
func (q djangoAdminLogQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schema: no djangoAdminLogQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from django_admin_log")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by deleteall for django_admin_log")
	}
...
func (o DjangoAdminLogSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from djangoAdminLog slice")
	}
...
func (o *DjangoAdminLogSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to reload all in DjangoAdminLogSlice")
	}
...
func DjangoAdminLogExists(exec boil.Executor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schema: unable to check if django_admin_log exists")
	}

	return exists, nil
}

// Exists checks if the DjangoAdminLog row exists.
func (o *DjangoAdminLog) Exists(exec boil.Executor) (bool, error) {
	return DjangoAdminLogExists(exec, o.ID)
}
