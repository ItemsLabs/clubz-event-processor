...
func testDjangoAdminLogsDelete(t *testing.T) {
	...
	count, err := DjangoAdminLogs().Count(tx)
	if err != nil {
		t.Error(err)
	}
...
func testDjangoAdminLogsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := DjangoAdminLogs().DeleteAll(tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testDjangoAdminLogsExists(t *testing.T) {
	...
	e, err := DjangoAdminLogExists(tx, o.ID)
	if err != nil {
...
func testDjangoAdminLogsFind(t *testing.T) {
	...
	djangoAdminLogFound, err := FindDjangoAdminLog(tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func testDjangoAdminLogsBind(t *testing.T) {
	...
	if err = DjangoAdminLogs().Bind(nil, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testDjangoAdminLogsOne(t *testing.T) {
	...
	if x, err := DjangoAdminLogs().One(tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testDjangoAdminLogsAll(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = djangoAdminLogOne.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = djangoAdminLogTwo.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := DjangoAdminLogs().All(tx)
	if err != nil {
		t.Error(err)
	}
...
func testDjangoAdminLogsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(tx, boil.Whitelist(djangoAdminLogColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testDjangoAdminLogToOneDjangoContentTypeUsingContentType(t *testing.T) {
	...
	if err = local.L.LoadContentType(tx, false, (*[]*DjangoAdminLog)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testDjangoAdminLogToOneAuthUserUsingUser(t *testing.T) {
	...
	slice := DjangoAdminLogSlice{&local}
	if err = local.L.LoadUser(tx, false, (*[]*DjangoAdminLog)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testDjangoAdminLogToOneRemoveOpDjangoContentTypeUsingContentType(t *testing.T) {
	...
	count, err := a.ContentType().Count(tx)
	if err != nil {
		t.Error(err)
	}
	if count != 0 {
