...
func testAuthGroupPermissionsDelete(t *testing.T) {
	...
	count, err := AuthGroupPermissions().Count(tx)
	if err != nil {
		t.Error(err)
	}
...
func testAuthGroupPermissionsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := AuthGroupPermissions().DeleteAll(tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testAuthGroupPermissionsExists(t *testing.T) {
	...
	e, err := AuthGroupPermissionExists(tx, o.ID)
	if err != nil {
...
func testAuthGroupPermissionsFind(t *testing.T) {
	...
	authGroupPermissionFound, err := FindAuthGroupPermission(tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func testAuthGroupPermissionsBind(t *testing.T) {
	...
	if err = AuthGroupPermissions().Bind(nil, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testAuthGroupPermissionsOne(t *testing.T) {
	...
	if x, err := AuthGroupPermissions().One(tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testAuthGroupPermissionsAll(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = authGroupPermissionOne.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = authGroupPermissionTwo.Insert(tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := AuthGroupPermissions().All(tx)
	if err != nil {
		t.Error(err)
	}
...
func testAuthGroupPermissionsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.Begin())
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(tx, boil.Whitelist(authGroupPermissionColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testAuthGroupPermissionToOneAuthPermissionUsingPermission(t *testing.T) {
	...
	if err = local.L.LoadPermission(tx, false, (*[]*AuthGroupPermission)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testAuthGroupPermissionToOneAuthGroupUsingGroup(t *testing.T) {
	...
	slice := AuthGroupPermissionSlice{&local}
	if err = local.L.LoadGroup(tx, false, (*[]*AuthGroupPermission)(&slice), nil); err != nil {
		t.Fatal(err)
	}
